...
public class Grameenphone extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_main) {
            Intent i = new Intent(Grameenphone.this,MainActivity.class);startActivity(i);
        } else if (id == R.id.nav_gp) {

        } else if (id == R.id.nav_bl) {
            Intent i = new Intent(Grameenphone.this,Banglalink.class);startActivity(i);
        } else if (id == R.id.nav_rb) {
            Intent i = new Intent(Grameenphone.this,Robi.class);startActivity(i);
        } else if (id == R.id.nav_at) {
            Intent i = new Intent(Grameenphone.this,Airtel.class);startActivity(i);
        } else if (id == R.id.nav_tt) {
            Intent i = new Intent(Grameenphone.this,Teletalk.class);startActivity(i);
        } else if (id == R.id.nav_st) {
            Intent i = new Intent(Grameenphone.this,Skitto.class);startActivity(i);
